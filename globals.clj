...
(def fpath_base "/Users/rflores/wikiindexer/")
...
(def dl_network_exception_sleep   (* 1 1 100))  ;milliseconds to sleep before retry in case of network exception (11 minutes)
